    ...
    <main className="bg-white overflow-x-hidden">
      ...
      <section className="py-10 md:py-14 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Hero card */}
          <div className="relative rounded-3xl overflow-hidden p-8 md:p-14" style={{ background: "linear-gradient(135deg, #e8f0fe 0%, #dbeafe 40%, #ede9fe 100%)" }}>
            {/* Decorative blobs */}
            <div className="pointer-events-none absolute -top-16 -right-16 w-72 h-72 rounded-full opacity-30" style={{ background: "radial-gradient(circle, #93c5fd, transparent 70%)" }} />
            <div className="pointer-events-none absolute -bottom-10 left-10 w-56 h-56 rounded-full opacity-20" style={{ background: "radial-gradient(circle, #a5b4fc, transparent 70%)" }} />

            <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">

              {/* Left */}
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/70 text-blue-700 text-xs font-semibold mb-6 border border-blue-100">
                  <Zap size={12} />
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Link
                    href="/az/calculators"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-semibold text-gray-700 bg-white border border-gray-200 hover:border-blue-300 hover:text-blue-700 transition-all shadow-sm"
                  >
                    <Calculator size={16} />
                    Kalkulyatorlar
                  </Link>
              ...
              <div className="flex justify-center lg:justify-end">
                <div className="bg-white rounded-3xl shadow-xl w-full max-w-sm overflow-hidden">
                  ...
                  <div className="border-t border-gray-100 px-6 py-3">
                    <Link href="/az/kredit-yoxlama" className="flex items-center justify-between text-sm font-semibold text-blue-600 hover:text-blue-700 transition-colors group">
                      Ətraflı hesabatı göstər
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6">
            {[
              { icon: <Shield size={18} className="text-blue-500" />, title: "100%", sub: "Təhlükəsiz" },
              { icon: <Zap size={18} className="text-blue-500" />, title: "3 dəqiqə", sub: "Nəticə vaxtı" },
              { icon: <CheckCircle size={18} className="text-blue-500" />, title: "Sanadsız", sub: "Sadə yoxlama" },
              { icon: <Lock size={18} className="text-blue-500" />, title: "Məlumatınız", sub: "mühafizə olunur" },
            ].map((b) => (
              <div key={b.title} className="flex items-center gap-3 bg-white rounded-2xl px-4 py-3.5 border border-gray-100 shadow-sm">
                {b.icon}
                <div>
